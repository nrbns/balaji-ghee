      ...
      <AnimatePresence>
        {isOpen && (
          <motion.aside
            ...
            className="fixed right-0 top-0 z-[55] h-full w-full max-w-xl overflow-y-auto border-l border-[var(--gold)]/20 bg-[var(--cream)]/95 backdrop-blur-xl shadow-2xl"
          >
            <div className="sticky top-0 flex items-center justify-between border-b border-[var(--gold)]/30 bg-[var(--cream)]/95 px-6 py-4">
              <div>
                <p className="text-sm uppercase tracking-wide text-[var(--gold-medium)]">Master Admin</p>
                <h2 className="text-2xl font-semibold text-[var(--warm-black)]">Experience Controls</h2>
              </div>
              <button
            ...
            <div className="space-y-8 px-6 py-6">
              ...
              <section className="rounded-2xl border border-[var(--gold)]/20 bg-white/80 p-6 shadow-md">
                ...
                <div className="space-y-6">
                  {config.products.map((product, index) => (
                    <div
                      key={product.id}
                      className="rounded-xl border border-[var(--gold)]/20 bg-white/70 p-4 shadow-sm"
                    >
                      <div className="mb-4 flex items-center justify-between">
                        <div>
                      ...
                      <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-[200px_1fr]">
                        ...
                        <p className="text-sm text-[var(--warm-gray)]">
                          ...
                          For best results use 1:1 imagery with luxurious warm tonality.
                        </p>
                      </div>
                    </div>
                  ))}
              ...
              <section className="rounded-2xl border border-[var(--gold)]/20 bg-white/60 p-6 text-sm text-[var(--warm-gray)] shadow-sm">
                <h3 className="mb-2 text-lg font-semibold text-[var(--warm-black)]">How it works</h3>
                <p className="mb-3">
                  The master admin panel lets you orchestrate the hero storytelling and featured products directly inside the live
                  experience. All adjustments happen instantly in the browser for rapid merchandising experiments.
                </p>
                <ul className="list-disc space-y-1 pl-5">
                  <li>Hero copy, imagery, and CTAs refresh in real-time.</li>
                  <li>Product updates flow into the luxury showcase grid instantly.</li>
                  <li>Add, rename, or stage premium jars before activating campaigns.</li>
                </ul>
              </section>
            </div>
          </motion.aside>
